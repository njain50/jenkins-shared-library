...
10. configure Jenkins as follows: ![jenkins configuration](2.0.1_jenkins_nodes_configuration.jpg)
    
11. Configure credentials as follows: configure Jenkins as follows: ![jenkins credentials configuration](2.0.2_jenkins_nodes_credential.jpg)
...
```
14. Node is now successfully connected: ![jenkins node successfully connected](2.0.3_jenkins_node_successfully_connected.jpg)
